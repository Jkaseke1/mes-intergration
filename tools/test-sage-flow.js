...
(async () => {
  ...
  try {
    ...
    await postInventoryTransaction(pool, {
      ...
      whseId: 18,
      unitCost: cost,
      reference: 'TEST-FLOW-GRN',
      description: 'Test GRN for flow',
    ...
    await postInventoryTransaction(pool, {
      ...
      whseId: 18,
      unitCost: cost,
      reference: 'TEST-FLOW-ISSUE',
      description: 'Test issue for flow',
      transactionDate: new Date()
    });
    ...
    await postInventoryTransaction(pool, {
      ...
      whseId: 20,
      unitCost: cost,
      reference: 'TEST-FLOW-PROD',
      description: 'Test production for flow',
      transactionDate: new Date()
    });
    ...
    await postInventoryTransaction(pool, {
      ...
      whseId: 20,
      unitCost: cost,
      reference: 'TEST-FLOW-DSP',
      description: 'Test dispatch issue',
      transactionDate: new Date()
    });
    ...
    await postInventoryTransaction(pool, {
      ...
      whseId: 36,
      unitCost: cost,
      reference: 'TEST-FLOW-DSP-RCV',
      description: 'Test dispatch receipt',
      transactionDate: new Date()
    });
